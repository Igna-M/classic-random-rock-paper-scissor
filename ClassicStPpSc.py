...
def strike():
    hand = random.choice(['Stone', 'Paper', 'Scissor'])
    return hand
...
def who_won(human_weapon, robot):
    if (human_weapon == 'Stone' and robot == 'Stone') or (human_weapon == 'Paper' and robot == 'Paper') or (human_weapon == 'Scissor' and robot == 'Scissor'):
        winner = 'none'
        print('Empate')
    elif (human_weapon == 'Stone' and robot == 'Scissor') or (human_weapon == 'Paper' and robot == 'Stone') or (human_weapon == 'Scissor' and robot == 'Paper'):
        winner = 'human'
...
def query_player():
    ...
    while human not in options:
        human = input('Stone(1), Paper(2), or Scissor(3)? ')
